...
function Header({ placeholder }) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
      ...
      >
        <Image
          src="https://raw.githubusercontent.com/SedatCeyhan/LogoStorage/093aa309ab8acc7f7740dfc29db400a0cb3b589a/house-5.svg" //@@@@@@@@@@@@@@@@@@@
          layout="fill"
          objectFit="contain"
          objectPosition="left"
        />
        <h1 className="hidden md:inline-flex ml-14 text-xl text-[#00b0ff]">Housing App</h1>
      </div>
      {/* Search */}
      <div className="flex items-center md:border-2 rounded-full md:shadow-sm py-2">
        ...
        />
        <SearchIcon className="h-8 hidden md:inline-flex p-2 mx-auto cursor-pointer md:mx-2 bg-[#00b0ff] rounded-full text-white" />
      </div>
      {/* Right */}
